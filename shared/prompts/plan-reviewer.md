...
Inputs: approved frontend prototype evidence and mock inventory when UI-facing, prd.md, technical.md, spec.md, testcases.md, plan/*.md, project AGENTS.md, project commands.
